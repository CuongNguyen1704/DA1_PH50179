...
class Cart
{
    ...
    {
        try {
            $sql = "SELECT g.*, sp.ten_san_pham, sp.gia,
       GROUP_CONCAT(DISTINCT hasp.hinh_sp) AS hinh_sp AS hinh_sp,
       ...
       r.gia_tang AS ram_gia_tang
        ...
        GROUP BY g.gio_hang_id, sp.ten_san_pham, sp.gia, r.dung_luong, r.gia_tang, g.so_luong
